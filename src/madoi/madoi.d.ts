...
export declare type CastType = "UNICAST" | "MULTICAST" | "BROADCAST" | "OTHERCAST" | "SELFCAST" | "CLIENTTOSERVER" | "SERVERTOCLIENT";
...
export declare type UpstreamMessageType = LoginRoom | UpdatePeerProfile | ObjectDefinition | MethodDefinition | FunctionDefinition | ObjectState | Invocation;
export declare type DownStreamMessageType = EnterRoom | LeaveRoom | PeerJoin | PeerLeave | UpdatePeerProfile | Invocation | ObjectState;
export declare type StoredMessageType = Invocation | ObjectState;
...
export declare class Madoi {
    ...
    constructor(servicePath: string, key?: string, roomSpecs?: {}, profile?: {});
